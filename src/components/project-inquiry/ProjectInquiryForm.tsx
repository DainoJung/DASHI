...
export function ProjectInquiryForm() {
  ...
  const { register, handleSubmit, formState: { errors } } = useForm<ProjectInquiryFormData>();
  ...
  return (
    ...
    >
      ...
      <InputField
        ...
        {...register('budget', { required: '예산 범위를 선택해주세요.' })}
        error={errors.budget}
      />
      <InputField
        label="예상 일정"
        ...
        {...register('timeline', { required: '예상 일정을 선택해주세요.' })}
